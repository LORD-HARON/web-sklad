...
@Component({
    selector: 'app-vertical-three-two-right-action',
    templateUrl: './vertical-three-two-right-action.component.html',
    styleUrl: './vertical-three-two-right-action.component.scss'
})
export class VerticalThreeTwoRightActionComponent implements OnInit {
