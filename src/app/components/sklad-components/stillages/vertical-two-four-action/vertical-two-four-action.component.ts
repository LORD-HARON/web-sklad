...
@Component({
    selector: 'app-vertical-two-four-action',
    templateUrl: './vertical-two-four-action.component.html',
    styleUrl: './vertical-two-four-action.component.scss'
})
export class VerticalTwoFourActionComponent implements OnInit {
