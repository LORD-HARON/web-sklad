...
@Component({
    selector: 'app-vertical-three-three-right-action',
    templateUrl: './vertical-three-three-right-action.component.html',
    styleUrl: './vertical-three-three-right-action.component.scss'
})
export class VerticalThreeThreeRightActionComponent implements OnInit {
